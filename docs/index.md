...
features:
  ...
  - icon: 📦
    title: Jeden plik HTML
    details: Cała aplikacja waży ~280 KB. Wyślij plik e-mailem, zapisz na pendrive — działa w każdej przeglądarce bez instalacji.
---
