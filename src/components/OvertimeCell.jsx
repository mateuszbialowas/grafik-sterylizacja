...
export default function OvertimeCell({ value, isWeekendDay, onClick, onContextMenu }) {
  if (!value) return <td className={"border border-gray-200 text-center cursor-pointer select-none hover:bg-orange-50 " + (isWeekendDay ? "bg-gray-100" : "")} style={{ width: 38, minWidth: 38, maxWidth: 38, height: 40, padding: 0 }} onClick={onClick} />;
  ...
  return (
    <td className="border border-gray-200 text-center cursor-pointer select-none bg-[#ffedd5] text-[#9a3412] text-[10px] font-bold leading-tight hover:bg-[#fed7aa] relative group/ot" style={{ width: 38, minWidth: 38, maxWidth: 38, height: 40, padding: 0 }} onClick={onClick} onContextMenu={onContextMenu}>
